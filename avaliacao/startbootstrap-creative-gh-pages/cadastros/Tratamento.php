<form action="">
    ...
    <div class="form-group">
        ...
        <textarea name="exercicio" id="" cols="30" rows="10" class="form-control"></textarea>
    </div>
    <div class="form-group">
        <label for="">Alimentação:</label>
        <textarea name="alimentacao" id="" cols="30" rows="10" class="form-control"></textarea>
    </div>
    <div class="form-group">
        <label for="">Medicamento:</label>
        <textarea name="medicamento" id="" cols="30" rows="10" class="form-control"></textarea>
    </div>
</form>